...
$redist_parent_dir = "C:\Program Files\Microsoft Visual Studio\2022\Enterprise\VC\Redist\MSVC"
...
$redist_dir="$redist_parent_dir\$redist_ver\x64\Microsoft.VC144.CRT"
